...
map.getView().fit([-9725048.266841, -7474867.241153, -3903389.076160, -2417000.113712], map.getSize());
            ...
            if (typeof clusteredFeatures !== "undefined") {
                if (doPopup) {
                    for(var n=0; n<clusteredFeatures.length; n++) {
                        ...
                        currentFeatureKeys = ["Provincia","Localidad","Tipo","Recurso","Telefono codificado","Correo electrónico","WEB","Redes sociales | Instagram"];
                        popupText += '<li><table>'
